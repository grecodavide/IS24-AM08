    ...
    public void run() {
        ...
        while (!this.socket.isClosed() && this.socket.isConnected()) {
            try {
                ...
                response = (ResponseMessage) io.stringToMsg(message);
                ...
                switch (response) {
                    ...
                    case MatchStartedMessage msg:
                        ...
                        Pair<Symbol, Symbol> decksTop =
                                new Pair<Symbol, Symbol>(msg.getVisibleDeckReigns()[0], msg.getVisibleDeckReigns()[1]);
                    ...
                    case SomeonePlayedCardMessage msg:
                        ...
                        this.networkView.someonePlayedCard(username, coords, this.getPlayable(msg.getCardID()), msg.getSide(),
                                msg.getPoints(), msg.getAvailableResources());
                        break;
                ...
                // ignore, message wrongly formatted
            }
        }
    }
