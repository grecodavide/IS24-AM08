...
public final class CardsManager {
    ...
    private CardsManager() {
        ...
        Type goldCardsType = new TypeToken<Map<Integer, InitialCard>>(){}.getType();
        Type resourceCardsType = new TypeToken<Map<Integer, InitialCard>>(){}.getType();
        Type objectivesType = new TypeToken<Map<Integer, InitialCard>>(){}.getType();
