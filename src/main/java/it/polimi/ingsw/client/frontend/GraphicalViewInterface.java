...
public abstract class GraphicalViewInterface {
    ...
    protected Objective[] visibleObjectives;
    ...
    public void matchStarted(Objective[] visibleObjectives, Map<DrawSource, Integer> visibleCards, Symbol[] visibleDeckReigns,
            Map<String, PlayableCard[]> playerHands, Map<String, Color> playerPawnColors) {
