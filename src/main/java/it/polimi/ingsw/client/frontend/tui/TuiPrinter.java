...
public class TuiPrinter {
    ...
    private void printYouLoseScreen(int x, int y) {
        ...
        prefix = setPosition(x, ++y);
        loseString.add(
                prefix + " @@ì ì@@  @@ì  @@@  @@ì  @@@     @@ì       @@ì  @@@  ì@@       @@ì     ");
        prefix = setPosition(x, ++y);
        loseString.add(
                prefix + " ì@ì @ìì  ì@ì  @ì@  ì@ì  @ì@     ì@ì       ì@ì  @ì@  ì@ì       ì@ì     ");
        prefix = setPosition(x, ++y);
        loseString.add(
                prefix + "  ì@ì@ì   @ì@  ì@ì  @ì@  ì@ì     @ìì       @ì@  ì@ì  ìì@@ìì    @ììì:ì  ");
        prefix = setPosition(x, ++y);
        loseString.add(
                prefix + "   @ììì   ì@ì  ììì  ì@ì  ììì     ììì       ì@ì  ììì   ìì@ììì   ììììì:  ");
        prefix = setPosition(x, ++y);
        loseString.add(
                prefix + "   ìì:    ìì:  ììì  ìì:  ììì     ìì:       ìì:  ììì       ì:ì  ìì:     ");
        prefix = setPosition(x, ++y);
        loseString.add(
                prefix + "   :ì:    :ì:  ì:ì  :ì:  ì:ì      :ì:      :ì:  ì:ì      ì:ì   :ì:     ");
        prefix = setPosition(x, ++y);
        loseString.add(
                prefix + "    ::    ::::: ::  ::::: ::     :: ::::   ::::: ::  :::: ::   :: :::: ");
        prefix = setPosition(x, ++y);
